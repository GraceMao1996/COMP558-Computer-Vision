...
for i=9:9
    ...
    [Vx, Vy] = demo_optical_flow('Schefflera',i,i+1,"LK_pyramid");
    ...
    if(i < 10)
        ...
        Image_current = imread(fullfile('Schefflera',strcat('frame0',num2str(i),'.png')));
    else
        Image_current = imread(fullfile('Schefflera',strcat('frame',num2str(i),'.png')));
    end
